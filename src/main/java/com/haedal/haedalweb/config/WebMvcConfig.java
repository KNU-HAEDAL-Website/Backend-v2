...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public WebMvcConfig(@Value("${file.path.upload-board-images}") String boardUploadPath,
		@Value("${file.url.upload-board-images}") String boardUploadUrl,
		@Value("${file.path.upload-profile-images}") String profileUploadPath,
		@Value("${file.url.upload-profile-images}") String profileUploadUrl,
		@Value("${file.path.upload-post-images}") String postUploadPath,
		@Value("${file.url.upload-post-images}") String postUploadUrl,
		@Value("${file.url.upload-default-images}") String defaultUploadUrl) {
