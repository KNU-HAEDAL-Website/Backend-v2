    ...
    public SecurityFilterChain filterChain(HttpSecurity http, LoginFilter loginFilter) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers("/posts/{postId}","/boards/{boardId}/posts", "/posts","/activities/{activityId}/boards","/activities/{activityId}/boards/{boardId}","/login", "/", "/join/**", "/reissue", "/users/**","/semesters/**", "/swagger-ui/**", "/v3/api-docs/**", "/error/**").permitAll()
