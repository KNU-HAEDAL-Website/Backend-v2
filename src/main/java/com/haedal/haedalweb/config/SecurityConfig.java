    ...
    public SecurityFilterChain filterChain(HttpSecurity http, LoginFilter loginFilter) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers("/notices/**","/boards/{boardId}/posts/**","/activities/{activityId}/boards/**","/login", "/", "/join/**", "/reissue", "/users/{userId}/profile", "/profiles", "/semesters/**", "/swagger-ui/**", "/v3/api-docs/**", "/error/**", "/upload/**").permitAll()
