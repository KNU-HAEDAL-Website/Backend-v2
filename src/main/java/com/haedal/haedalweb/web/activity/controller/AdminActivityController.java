...
public class AdminActivityController {
	...
	@PostMapping
	public ResponseEntity<SuccessResponse> registerActivity(@PathVariable Long semesterId,
	...
	public ResponseEntity<SuccessResponse> removeActivity(@PathVariable Long semesterId,
