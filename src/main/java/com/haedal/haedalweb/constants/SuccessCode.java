...
public enum SuccessCode implements ResponseCode {
	...
	CANCEL_USER_ACCOUNT(HttpStatus.OK, true, "계정을 탈퇴했습니다."),
	UPDATE_USER_PASSWORD(HttpStatus.OK, true, "비밀번호를 변경했습니다."),
	...
	UPDATE_POST_SUCCESS(HttpStatus.OK, true, "게시글을 수정했습니다."),
