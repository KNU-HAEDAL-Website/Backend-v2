...
public class ProfileAppServiceImpl implements ProfileAppService {
    ...
    public ProfileAppServiceImpl(ProfileService profileService, SecurityService securityService, ApplicationEventPublisher applicationEventPublisher, @Value("${file.path.upload-profile-images}") String uploadPath, @Value("${file.url.upload-profile-images}") String uploadUrl, @Value("${file.url.upload-default-images}") String defaultUrl) {
